# Streaming LLM Response Support for Ruslan Agent
...
```
RUSLAN_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("RUSLAN_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `ruslan_cli/config.py` | 1 | +streaming config defaults |
