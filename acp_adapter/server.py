...
class HermesACPAgent(acp.Agent):
    ...
    async def prompt(
        ...
        **kwargs: Any,
        ...
        # not the executor's. Also set RUSLAN_INTERACTIVE so approval.py
        ...
        def _run_agent() -> dict:
            ...
            previous_interactive = os.environ.get("RUSLAN_INTERACTIVE")
            ...
            try:
                ...
                # Restore RUSLAN_INTERACTIVE.
                if previous_interactive is None:
                    os.environ.pop("RUSLAN_INTERACTIVE", None)
                else:
                    os.environ["RUSLAN_INTERACTIVE"] = previous_interactive
