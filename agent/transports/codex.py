...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Ruslan's web-provider config and
        ...
        # native search engine for xAI sessions instead of Ruslan's
        # configured web provider (Tavily/etc.), and those results bypass
        # Ruslan's tool-trace / citation plumbing (they arrive baked into the
