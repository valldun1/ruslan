"""Vertex AI (Google Cloud) adapter for Ruslan Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Ruslan to use Gemini models via Google Cloud with
...
# who installed plain `ruslan-agent` and only later selected a Gemini model.
try:
