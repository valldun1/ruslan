...
```bash
curl -fsSL https://raw.githubusercontent.com/valldun1/hermes-on-android/main/install.sh | bash
```

> ⚠️ Replace `YOUR_USERNAME` with the actual repo owner once forked/mirrored.
...
Смотри [README](https://github.com/valldun1/hermes-on-android) или читай ниже по шагам:
...
<p align="center">
  ⭐ Если проект помог — поставь звезду!<br>
  <a href="https://github.com/valldun1/hermes-on-android">GitHub</a>
</p>
