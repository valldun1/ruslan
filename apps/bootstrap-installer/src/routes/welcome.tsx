 ...
 *   - RUSLAN AGENT wordmark rendered in Collapse Bold, uppercase, tracked
...
export default function Welcome() {
  return (
    <div className="ruslan-fade-in flex h-full flex-col items-center justify-center gap-10 px-12 py-10">
      ...
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>RUSLAN AGENT</span>
          </span>
          <span aria-hidden="true">RUSLAN AGENT</span>
        </p>
