...
/**
 * Return true iff `python -c "import ruslan_cli"` exits 0.
 *
...
function canImportHermesCli(pythonPath) {
  ...
  try {
    execFileSync(pythonPath, ['-c', 'import ruslan_cli'], {
      stdio: 'ignore',
 ...
 *
 * @param {string} hermesCommand - Resolved absolute path to a ruslan
