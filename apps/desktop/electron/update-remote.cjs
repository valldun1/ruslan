 ...
 *
 * A public install can end up with `origin=git@github.com:valldun1/ruslan.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/valldun1/ruslan.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/valldun1/ruslan'
