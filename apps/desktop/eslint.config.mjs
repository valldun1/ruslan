...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @ruslan/plugin-sdk (+ react), never `@/…`
      ...
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@ruslan/shared'],
              message: 'Plugins import only @ruslan/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
