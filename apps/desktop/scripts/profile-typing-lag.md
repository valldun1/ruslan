...
cd apps/desktop
XCURSOR_SIZE=24 RUSLAN_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/ruslan-typing
# → /tmp/ruslan-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/ruslan-typing.before.heapsnapshot
# → /tmp/ruslan-typing.after.heapsnapshot
```
