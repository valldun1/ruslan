...
const FOCUS_EVENT = 'ruslan:composer-focus'
const INSERT_EVENT = 'ruslan:composer-insert'
const INSERT_REFS_EVENT = 'ruslan:composer-insert-refs'
const SUBMIT_EVENT = 'ruslan:composer-submit'
const VOICE_TOGGLE_EVENT = 'ruslan:composer-voice-toggle'
