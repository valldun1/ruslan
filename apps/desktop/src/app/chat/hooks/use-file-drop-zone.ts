...
import { type DroppedFile, extractDroppedFiles, RUSLAN_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, RUSLAN_PATHS_MIME) ? 'files' : null
