...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/ruslan'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('ruslan:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('ruslan:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Ruslan to
