...
import type { ProjectInfo, SessionInfo } from '@/ruslan'
 ...
 * repo shows its branches/worktrees even when they have no Ruslan sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: RuslanGitWorktree[]
): SidebarSessionGroup[] {
