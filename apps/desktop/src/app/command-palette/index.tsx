...
import { getRuslanConfigRecord, listAllProfileSessions } from '@/ruslan'
...
// Ruslan session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          },
          {
            icon: Download,
            id: 'cc-update-ruslan',
            keywords: ['update', 'upgrade', 'ruslan', 'version', 'system', 'restart'],
            label: cc.updateRuslan,
