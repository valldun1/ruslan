...
import { getSessionMessages, triggerCronJob } from '@/ruslan'
...
import { useRuslanConfig } from '../session/hooks/use-ruslan-config'
...
export function ContribWiring({ children }: { children: ReactNode }) {
  ...
  const { refreshRuslanConfig, sttEnabled, voiceMaxRecordingSeconds } = useRuslanConfig({
    activeSessionIdRef,
