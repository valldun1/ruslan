...
import { getCronJobs, getSessionMessages, listAllProfileSessions, type SessionInfo, triggerCronJob } from '../ruslan'
...
import { useHermesConfig } from './session/hooks/use-ruslan-config'
...
export function DesktopController() {
  ...
  // ruslan:// deep links (e.g. a docs "Send to App" button for an automation blueprint).
