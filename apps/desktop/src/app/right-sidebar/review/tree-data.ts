import type { RuslanReviewFile } from '@/global'
...
export function buildReviewFlatList(files: RuslanReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: RuslanReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
