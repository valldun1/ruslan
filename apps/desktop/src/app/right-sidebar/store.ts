...
const TAKEOVER_KEY = 'ruslan.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Ruslan can't clear via the API — the user
 *  sees exactly what runs instead of Ruslan silently deleting their creds. */
