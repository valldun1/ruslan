...
describe('settings helpers', () => {
  ...
  it('reads and writes nested config paths', () => {
    const config: RuslanConfigRecord = { display: { theme: 'mono' } }
  ...
  it('rejects prototype-polluting config paths', () => {
    const config: RuslanConfigRecord = {}
  ...
  describe('providerGroup', () => {
    ...
    it('prefers the longest matching prefix so CN/regional buckets win', () => {
      ...
      // RUSLAN_QWEN_ shares the RUSLAN_ stem with other integrations.
      expect(providerGroup('RUSLAN_QWEN_BASE_URL')).toBe('DashScope (Qwen)')
