...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/ruslan'
...
// / Program Files), which buried any files Ruslan wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.ruslanDesktop` is
    ...
    const settings = window.ruslanDesktop?.settings
