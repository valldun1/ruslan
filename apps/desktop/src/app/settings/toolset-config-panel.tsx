...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/ruslan'
 ...
 * log inline — the GUI equivalent of the install step `ruslan tools` runs
