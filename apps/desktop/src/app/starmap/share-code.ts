...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/ruslan'
...
const VERSION = 3
const PREFIX = 'HML' // "Ruslan Memory Loadout" — namespaces our codes like WoW's leading bytes.
