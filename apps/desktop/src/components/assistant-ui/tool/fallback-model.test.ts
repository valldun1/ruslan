  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://ruslan-agent.nousresearch.com/docs' },
    ...
    expect(view.title).toBe('Failed to open ruslan-agent.nousresearch.com/docs')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://ruslan-agent.nousresearch.com/docs' },
        result: { success: true, url: 'https://ruslan-agent.nousresearch.com/docs', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened ruslan-agent.nousresearch.com/docs')
  })
})
