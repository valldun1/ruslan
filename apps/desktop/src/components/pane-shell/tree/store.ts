...
const STORAGE_KEY = 'ruslan.desktop.layoutTree.v2'

writeKey('ruslan.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('ruslan.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('ruslan.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'ruslan.desktop.dismissedPanes.v1'
...
const USER_PLACED_KEY = 'ruslan.desktop.userPlacedPanes.v1'
...
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__RUSLAN_LAYOUT_TREE__ = {
    close: closeTreePane,
