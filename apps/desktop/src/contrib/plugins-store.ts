 ...
 * `<ruslan home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'ruslan.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'ruslan.desktop.disabledPlugins.v1'
