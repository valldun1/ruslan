...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'Starting Ruslan Desktop…'
    },
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteDesc:
        'Connect this desktop shell to a remote Ruslan backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Ruslan Desktop will reconnect using the saved settings.',
  ...
  commandCenter: {
    ...
    hermesActiveSessions: (version, count) => `Ruslan ${version} · Active sessions ${count}`,
  ...
  onboarding: {
    ...
    flowSubtitles: {
      ...
      loopback: 'Opens your browser to sign in — Ruslan connects automatically',
