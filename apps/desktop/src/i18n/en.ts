...
export const en: Translations = {
  ...
  boot: {
    ready: 'Ruslan Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Ruslan settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingRuslanDesktop: 'Starting Ruslan Desktop…'
    },
    errors: {
      backgroundExited: 'Ruslan background process exited.',
      backgroundExitedDuringStartup: 'Ruslan background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Ruslan backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateRuslan: 'Update Ruslan',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Ruslan Desktop.',
    ...
    native: {
      ...
      inputBody: 'Ruslan is waiting for your response.',
      turnDoneTitle: 'Ruslan finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Ruslan defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Ruslan writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Ruslan is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Ruslan asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Ruslan was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Ruslan follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Ruslan is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Ruslan, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Ruslan checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Ruslan configuration...',
    ...
    gateway: {
      ...
      intro:
        'Ruslan Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Ruslan backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset RUSLAN_DESKTOP_REMOTE_URL and RUSLAN_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Ruslan backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Ruslan backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Ruslan Cloud',
      cloudDesc: 'Sign in once to Ruslan Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Ruslan Cloud',
      cloudSignIn: 'Sign in to Ruslan Cloud',
      cloudSignedIn: 'Signed in to Ruslan Cloud',
      cloudNeedsSignIn: 'Sign in to Ruslan Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Ruslan Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Ruslan Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Ruslan Cloud',
      cloudSignedOutMessage: 'Cleared the Ruslan Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /ruslan.',
      ...
      restartingMessage: 'Ruslan Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Ruslan ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Ruslan runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via ruslan curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Ruslan builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Ruslan to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Ruslan to generate pets.',
      backgroundHint: 'You can close this — Ruslan will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Ruslan desktop' },
    ...
    ruslanActiveSessions: (version, count) => `Ruslan ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@ruslan:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Ruslan environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Ruslan will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Ruslan backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Ruslan. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Ruslan...',
    placeholderReconnecting: 'Reconnecting to Ruslan…',
    ...
    attachUrlDesc: 'Ruslan will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Ruslan to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Ruslan…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Ruslan…',
    ...
    unsupportedMessage: 'This version of Ruslan can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Ruslan from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Ruslan will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Ruslan desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Ruslan updater takes over in its own window and reopens Ruslan automatically when it’s done. Please don’t reopen Ruslan yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Ruslan reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Ruslan reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Ruslan needs a one-time install',
    ...
    settingUpTitle: 'Setting up Ruslan Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Ruslan CLI or desktop instance is running. Stop any running Ruslan instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Ruslan Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Ruslan is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Ruslan…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Ruslan',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Ruslan at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Ruslan connects automatically',
    ...
    authorizeThere: 'Authorize Ruslan there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Ruslan there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Ruslan inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Ruslan will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Ruslan is restarting...',
      askRestart: 'Ask Ruslan to restart the server',
      lookingRestart: taskId => `Ruslan is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Ruslan is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Ruslan finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Ruslan could not restart the server.',
      stillWorking:
        'Ruslan is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Ruslan is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Ruslan gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.ruslan/config.yaml). Ruslan won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Ruslan needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Ruslan needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Ruslan Desktop to use Save Image.',
    restartToSaveImages: 'Restart Ruslan Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `ruslan gateway` running?'
    }
  },
