...
export const zhHant = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: '正在啟動 Ruslan Desktop…'
    },
    errors: {
  ...
  commandCenter: {
    ...
    hermesActiveSessions: (version, count) => `Ruslan ${version} · 活躍工作階段 ${count}`,
  ...
  updates: {
    ...
    applyingBody: 'Ruslan 更新程式會在自己的視窗中接管，並在完成後自動重新開啟 Ruslan。更新期間請勿自行重新開啟 Ruslan。',
