...
export const zh: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: '正在启动 Ruslan 桌面版…'
    },
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteTitle: '远程网关',
      remoteDesc:
        '将此桌面外壳连接到远程 Ruslan 后端。托管网关使用 OAuth 或用户名密码；自托管网关也可能使用会话 token。',
      ...
      savedTitle: '网关设置已保存',
      restartingMessage: 'Ruslan Desktop 将使用已保存设置重新连接。',
  ...
  commandCenter: {
    ...
    hermesActiveSessions: (version, count) => `Ruslan ${version} · 活跃会话 ${count}`,
    restartGateway: '重启网关',
  ...
  updates: {
    ...
    guiSkewBody: '后端已更新，但此桌面应用包未更改。请更新或重新安装 Ruslan 桌面应用（你的 AppImage / .deb / .rpm）以保持一致。',
    copy: '复制',
    copied: '已复制',
    done: '完成',
    applyingBody: 'Ruslan 更新器会在自己的窗口中接管，并在完成后自动重新打开 Ruslan。更新期间请不要自行重新打开 Ruslan。',
