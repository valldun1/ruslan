...
/** Why a known Ruslan command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/version', description: 'Show Ruslan Agent version', surface: exec() },
 ...
 * Ruslan' built-in slash commands — i.e. skill commands (`/gif-search`,
