...
const desktopWindow = window as unknown as { ruslanDesktop?: Window['ruslanDesktop'] }
const initialRuslanDesktop = desktopWindow.ruslanDesktop

function installDesktopBridge(partial: Partial<Window['ruslanDesktop']> = {}) {
  desktopWindow.ruslanDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['ruslanDesktop']
}
...
afterEach(() => {
  ...
  if (initialRuslanDesktop) {
    desktopWindow.ruslanDesktop = initialRuslanDesktop
  } else {
    delete desktopWindow.ruslanDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['ruslanDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['ruslanDesktop']['openExternal'] })
