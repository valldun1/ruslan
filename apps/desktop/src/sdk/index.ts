/**
 * @ruslan/plugin-sdk — THE plugin language. The vscode-module model: plugin
 ...
 *    object as `window.__RUSLAN_PLUGIN_SDK__` and maps the import to it, so a
...
import { getLogs, getStatus } from '@/ruslan'
...
export type { RpcEvent, StatusResponse } from '@/types/ruslan'
