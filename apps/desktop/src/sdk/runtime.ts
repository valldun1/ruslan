 ...
 * plugins resolve `@ruslan/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __RUSLAN_PLUGIN_SDK__: sdk,
  __RUSLAN_REACT__: React,
  __RUSLAN_REACT_JSX__: jsxRuntime,
  __RUSLAN_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@ruslan/plugin-sdk': shimUrl('__RUSLAN_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__RUSLAN_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__RUSLAN_REACT_JSX__'),
    react: shimUrl('__RUSLAN_REACT__')
  }
