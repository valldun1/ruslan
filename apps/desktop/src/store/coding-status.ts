...
import type { RuslanGitWorktree, RuslanRepoStatus } from '@/global'
...
export const $repoStatus = atom<RuslanRepoStatus | null>(null)
...
export const $repoWorktrees = atom<RuslanGitWorktree[]>([])
