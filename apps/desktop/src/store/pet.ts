...
export interface PetInfo {
  ...
  // the Ruslan "run" activity state uses the in-place running row).
 ...
 * RUSLAN_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'ruslan.desktop.pet-roam.v1'
