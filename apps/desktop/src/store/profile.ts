...
// /api/profiles/active `current`). "default" is the root ~/.ruslan. This is the
...
const PROFILE_ORDER_STORAGE_KEY = 'ruslan.desktop.profileOrder'
...
const PROFILE_COLORS_STORAGE_KEY = 'ruslan.desktop.profileColors'
...
// Persist the choice and relaunch the backend under the new RUSLAN_HOME. The
...
const SHOW_ALL_PROFILES_STORAGE_KEY = 'ruslan.desktop.showAllProfiles'
...
// Switch to the default (root ~/.ruslan) profile — bound to ⌘1.
