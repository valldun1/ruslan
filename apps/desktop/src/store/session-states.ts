...
const TILES_KEY = 'ruslan.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'ruslan.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __RUSLAN_LAYOUT_TREE__).
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__RUSLAN_SESSION_TILES__ = {
