...
const SKIN_KEY = 'ruslan-desktop-theme-v2'
const MODE_KEY = 'ruslan-desktop-mode-v1'
...
const PROFILE_SKINS_KEY = 'ruslan-desktop-profile-themes-v1'
const PROFILE_MODES_KEY = 'ruslan-desktop-profile-modes-v1'
// Last active profile, recorded so the boot-time paint can pick that profile's
// theme before the gateway reports which profile actually launched.
const LAST_PROFILE_KEY = 'ruslan-desktop-active-profile-v1'
...
/** Sync the desktop skin with the active Ruslan backend theme on connect. */
