...
export default defineConfig({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\ruslan\ruslan-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@ruslan/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@ruslan/shared': path.resolve(__dirname, '../shared/src'),
