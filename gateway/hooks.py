...
Hooks are discovered from ~/.ruslan/hooks/ directories, each containing:
...
HOOKS_DIR = get_ruslan_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"ruslan_hook_{hook_name}"
