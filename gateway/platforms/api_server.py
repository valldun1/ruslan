...
- GET  /v1/models                  — lists ruslan-agent as an available model
...
class APIServerAdapter(BasePlatformAdapter):
    ...
    async def _handle_models(self, request: "web.Request") -> "web.Response":
        """GET /v1/models — return ruslan-agent as an available model."""
    ...
    async def _handle_chat_completions(self, request: "web.Request") -> "web.Response":
        ...
        if is_partial or is_failed or not completed:
            ...
            response_headers["X-Ruslan-Partial"] = "true" if is_partial else "false"
            if err_msg:
                response_headers["X-Ruslan-Error"] = err_msg[:200]
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # the June 2026 ruslan-0day hardening (an 8-char key dispatching
