...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$RUSLAN_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_ruslan_dir("platforms/whatsapp/session", "whatsapp/session")
