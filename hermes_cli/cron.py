...
def cron_list(show_all: bool = False):
    ...
    if not jobs:
        ...
        print(color("Создай через 'руслан cron create ...' или команду /cron в чате.", Colors.DIM))
        return
...
def cron_command(args):
    ...
    print("Использование: руслан cron [list|create|edit|pause|resume|run|remove|status|tick]")
    sys.exit(1)
