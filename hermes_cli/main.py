...
def cmd_whatsapp(args):
    ...
    if (session_dir / "creds.json").exists():
        ...
        if wa_mode == "bot":
            ...
            print()
            print("  Подсказка: ответы агента помечены '🛡 Руслан' в заголовке")
        else:
            print("  Next steps:")
            print("    1. Start the gateway:  hermes gateway")
            ...
            print()
            print("  Подсказка: ответы агента помечены '🛡 Руслан' в заголовке")
            print("  так ты отличишь их от своих сообщений.")
        print()
...
def _model_flow_custom(config):
    ...
    if probe.get("used_fallback") and probe.get("resolved_base_url"):
        ...
        print(
            ...
            f"Руслан всё равно сохранит это."
        )
...
def cmd_version(args):
    """Show version."""
    print(f"Руслан v{__version__} ({__release_date__})")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="hermes",
        description="Руслан - AI-агент с возможностью вызова инструментов",
...
""",
    ...
    import_parser = subparsers.add_parser(
        "import",
        help="Восстановить резервную копию Руслана из zip-файла",
        description="Распаковать ранее созданную резервную копию в домашний "
        "каталог Руслана, восстановив конфигурацию, скиллы, "
        "сессии и данные",
    )
