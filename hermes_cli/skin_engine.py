...
[dim #7A3511]⠀⠀⠀⠀⠀⠀⠀tail flame lit⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "ruslan": {
        "name": "ruslan",
        "description": "Руслан — зелёный и лаконичный",
        "colors": {
            "banner_border": "#00ff88",
            "banner_title": "#ffffff",
            "banner_accent": "#00ff88",
            "banner_dim": "#006644",
            "banner_text": "#e5e5e5",
            "ui_accent": "#00ff88",
            "ui_label": "#ffffff",
            ...
            "session_label": "#00ff88",
            "session_border": "#004d33",
        },
        "spinner": {
            "waiting_faces": ["(🛡)", "(⚔)", "(✦)", "(◈)", "(◆)"],
            "thinking_faces": ["(🛡)", "(⚔)", "(✦)", "(◈)", "(◆)"],
            "thinking_verbs": [
                "обрабатываю", "думаю", "анализирую",
                "проверяю", "собираю", "оптимизирую",
            ],
            "wings": [
                ["⟪🛡", "🛡⟫"],
                ["⟪✦", "✦⟫"],
        ...
        "branding": {
            "agent_name": "Руслан",
            "welcome": "Добро пожаловать в Руслан! Напиши сообщение или /help для списка команд.",
            "goodbye": "До встречи! 🛡",
