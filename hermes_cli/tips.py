...
TIPS = [
    ...
    # --- Cron & Scheduling ---
    "Cron tasks can load skills: руслан cron add --skill blogwatcher \"Check for new posts\".",
    ...
    # --- Gateway & Messaging ---
    "Руслан works on 21 messaging platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, IRC, Microsoft Teams, email, and more.",
    ...
    "Руслан loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
