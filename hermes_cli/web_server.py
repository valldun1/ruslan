...
app = FastAPI(title="Руслан", version=__version__, lifespan=_lifespan)
...
async def start_telegram_onboarding(body: TelegramOnboardingStart):
    bot_name = (body.bot_name or "Руслан").strip() or "Руслан"
...
_BUILTIN_DASHBOARD_THEMES = [
    {"name": "default",       "label": "Руслан",         "description": "Классический тёмный — каноничный вид Руслана"},
    {"name": "default-large", "label": "Руслан (Крупный)", "description": "Руслан с крупными шрифтами и просторным расположением"},
