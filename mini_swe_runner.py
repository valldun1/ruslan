#!/usr/bin/env python3
"""
SWE Runner with Ruslan Trajectory Format

A runner that uses Ruslan-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Ruslan-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Ruslan-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Ruslan format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Ruslan-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Ruslan-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Ruslan Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Ruslan-Agent's built-in execution environments
    and outputs trajectories in Ruslan-Agent format.
    """
    ...
    def _convert_to_ruslan_format(
        ...
        """
        Convert internal message format to Ruslan trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Ruslan trajectory format
        trajectory = self._convert_to_ruslan_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Ruslan trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Ruslan Trajectory Format")
    print("=" * 60)
