      ...
      let
        ...
        excludedDirs =
          ...
          ++ [
            ...
            "nix"
            # Skills are shipped via RUSLAN_BUNDLED_SKILLS /
            # RUSLAN_OPTIONAL_SKILLS (see ruslan-agent.nix), not via the
...
in
{
  ...
  #   npm = ruslanNpmLib.mkNpmPassthru { dirs = [ "apps/desktop" "apps/shared" ]; };
