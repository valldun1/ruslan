...
metadata:
  ruslan:
    ...
    credits: |
      ...
      https://github.com/valldun1/kanban-video-pipeline.
---
...
6. **The director never executes.** Even with the full `kanban + terminal +
   ...
   a `ruslan kanban create` call to a specialist profile. The kanban
