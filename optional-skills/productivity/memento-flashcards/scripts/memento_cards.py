...
Data file: $RUSLAN_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_RUSLAN_HOME = Path(os.environ.get("RUSLAN_HOME", Path.home() / ".ruslan"))
DATA_DIR = _RUSLAN_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
