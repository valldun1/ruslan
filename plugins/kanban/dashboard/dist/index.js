...
(function () {
  ...
  const DOCS_URL = "https://ruslan.team/docs/user-guide/features/kanban";
  const DOCS_TUTORIAL_URL = "https://ruslan.team/docs/user-guide/features/kanban-tutorial";
  ...
  function BoardColumns(props) {
    ...
    return h("div", { className: "ruslan-kanban-columns", onDragStart: handleDragStart, onDragEnd: handleDragEnd },
  ...
  function TaskDetail(props) {
    ...
    return h("div", { className: "ruslan-kanban-drawer-body" },
      ...
      t.result ? h("div", { className: "ruslan-kanban-section" },
