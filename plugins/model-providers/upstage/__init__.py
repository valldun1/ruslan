...
# When the user hasn't picked a reasoning effort, Ruslan passes
...
# ON at this effort — matching the "medium (default)" that Ruslan' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Ruslan' effort vocabulary onto Solar's accepted set. xhigh/max/
