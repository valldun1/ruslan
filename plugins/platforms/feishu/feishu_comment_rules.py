...
Config: ~/.ruslan/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.ruslan/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_ruslan_home()`` helper (RUSLAN_HOME-aware and
...
RULES_FILE = get_ruslan_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_ruslan_home() / "feishu_comment_pairing.json"
