...
required — uses aiohttp which is already a Ruslan dependency.
...
def interactive_setup() -> None:
    ...
    ``ruslan_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Ruslan delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # ruslan_cli/setup.py::_setup_mattermost function.
