...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Ruslan gateway adapter.

    Each inbound phone number gets its own Ruslan session (multi-tenant).
...
# static dict in ruslan_cli/gateway.py, and the _send_sms dispatch in
