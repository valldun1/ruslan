...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                from ruslan_cli.commands import telegram_menu_commands
    ...
    async def send_update_prompt(
        ...
        try:
            ...
            text = self.format_message(f"🛡️ *Update needs your input:*\n\n{prompt}{default_hint}")
    ...
    async def _handle_callback_query(
        ...
        try:
            await query.edit_message_text(
                text=self.format_message(f"🛡️ Update prompt answered: *{label}*"),
                parse_mode=ParseMode.MARKDOWN_V2,
                reply_markup=None,
            )
        except Exception:
