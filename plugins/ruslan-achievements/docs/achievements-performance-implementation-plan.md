# Ruslan Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.ruslan/plugins/ruslan-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.ruslan/plugins/ruslan-achievements/scan_checkpoint.json`.
