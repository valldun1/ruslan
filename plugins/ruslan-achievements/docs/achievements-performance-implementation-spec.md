# Ruslan Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.ruslan/plugins/ruslan-achievements/state.json` (existing unlock state)
  - `~/.ruslan/plugins/ruslan-achievements/scan_snapshot.json` (new)
  - `~/.ruslan/plugins/ruslan-achievements/scan_checkpoint.json` (new)
