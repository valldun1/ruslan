...
``_check_spotify_available()`` — when the user has not run ``ruslan auth
spotify``, the tools remain registered (so they appear in ``ruslan
...
The Spotify auth flow (``ruslan auth spotify``), CLI plumbing, and docs
