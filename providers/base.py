...
def _profile_user_agent() -> str:
    """Return a ``ruslan-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from ruslan_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"ruslan-cli/{_ver}"
    except Exception:
        return "ruslan-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # ruslan-cli UA so the catalog endpoint is reachable.
