"""
Ruslan CLI - Unified command-line interface for Ruslan Agent.

Provides subcommands for:
- ruslan chat          - Interactive chat (same as ./ruslan)
- ruslan gateway       - Run gateway in foreground
- ruslan gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    ruslan_cli/stdio.py::configure_windows_stdio() runs later from the entry
