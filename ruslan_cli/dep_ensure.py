...
def _has_ruslan_agent_browser() -> bool:
    ...
    # install.sh installs globally into $RUSLAN_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-RuslanHome", str(get_ruslan_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = ruslan_subprocess_env(inherit_credentials=False)
