"""Client for uploading ``ruslan debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``ruslan debug share``.
...
NAS_BASE = os.environ.get(
    "RUSLAN_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "ruslan-agent/debug-share"
