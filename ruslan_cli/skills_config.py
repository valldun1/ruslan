"""
Skills configuration for Ruslan Agent.
`ruslan skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.ruslan/config.yaml under:
...
from ruslan_cli.config import cfg_get, load_config, save_config
from ruslan_cli.colors import Colors, color
from ruslan_cli.platforms import PLATFORMS as _PLATFORMS
