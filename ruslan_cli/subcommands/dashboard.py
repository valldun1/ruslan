"""``ruslan dashboard`` subcommand parser.
...
def build_dashboard_parser(
    ...
    # for `ruslan dashboard` cmdlines and SIGTERM them directly — the same
    # path `ruslan update` uses to clean up stale dashboards.
    dashboard_parser.add_argument(
        "--stop",
        action="store_true",
        help="Stop all running ruslan dashboard processes and exit",
    )
    dashboard_parser.add_argument(
        "--status",
        action="store_true",
        help="List running ruslan dashboard processes and exit",
    )
