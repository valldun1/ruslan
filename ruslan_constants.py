...
def get_ruslan_home() -> Path:
    ...
    ``ruslan_cli/kanban_db.py``).  See https://github.com/valldun1/ruslan/issues/18594.
    """
...
def find_ruslan_node_executable(command: str) -> str | None:
    """Return a Ruslan-managed Node/npm executable path, if installed."""
...
def find_node_executable(command: str) -> str | None:
    """Resolve a Node.js command, preferring Ruslan-managed installs.
    ...
    """
    return find_ruslan_node_executable(command) or find_node_executable_on_path(command)
...
def secure_parent_dir(path: Path) -> None:
    ...
    See https://github.com/valldun1/ruslan/issues/25821.
    """
