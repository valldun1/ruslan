#!/usr/bin/env python3
"""Build the Ruslan Model Catalog — a centralized JSON manifest of curated models.
...
Ruslan CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Ruslan release.
...
# Ensure RUSLAN_HOME is set for imports that touch it at module level.
os.environ.setdefault("RUSLAN_HOME", os.path.join(os.path.expanduser("~"), ".ruslan"))

from ruslan_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "ruslan-agent repo",
            "docs": "https://ruslan-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Ruslan '
