#!/usr/bin/env python3
"""Build the Ruslan Skills Index — a centralized JSON catalog of all skills.
...
`ruslan skills search/install` can use it without hitting the GitHub API.
...
# Ensure RUSLAN_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Ruslan Skills Index...", flush=True)
