...
DEFAULT_DATASETS = [
    ...
    "NousResearch/ruslan-agent-megascience-sft1",
    "NousResearch/Ruslan-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Ruslan-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-ruslan-agent"
]
