...
Built for [Ruslan Agent](https://github.com/NousResearch/ruslan-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/ruslan-agent/skills/creative/ascii-video`](https://github.com/NousResearch/ruslan-agent/tree/main/skills/creative/ascii-video) via PR.
