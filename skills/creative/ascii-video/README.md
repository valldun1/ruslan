...
Built for [Ruslan Agent](https://github.com/valldun1/ruslan). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/ruslan-agent/skills/creative/ascii-video`](https://github.com/valldun1/ruslan/tree/main/skills/creative/ascii-video) via PR.
