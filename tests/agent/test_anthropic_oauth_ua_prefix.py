...
class TestOAuthUserAgentPrefix:
    ...
    def test_token_exchange_ua_not_throttled(self):
        """run_ruslan_oauth_login_pure must NOT send a throttled token-endpoint UA.
        ...
        try:
            source = inspect.getsource(mod.run_ruslan_oauth_login_pure)
        except AttributeError:
            pytest.skip("run_ruslan_oauth_login_pure not found")
        ...
        assert "_OAUTH_TOKEN_USER_AGENT" in source, (
            "run_ruslan_oauth_login_pure should send the shared "
