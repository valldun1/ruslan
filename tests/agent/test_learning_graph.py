...
def test_ruslan_meta_tolerates_non_dict():
    assert learning_graph._ruslan_meta({"metadata": "junk"}) == {}
    assert learning_graph._ruslan_meta({"metadata": {"ruslan": "junk"}}) == {}
    assert learning_graph._ruslan_meta({"metadata": {"ruslan": {"category": "x"}}}) == {"category": "x"}
