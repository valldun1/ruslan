...
thinking phase.  Ruslan's default cloud-stream stale detector
(``RUSLAN_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``RUSLAN_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
