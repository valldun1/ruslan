...
we don't pay the full RuslanCLI.__init__ cost; a synthetic spritesheet exercises
...
def boba_like(tmp_path, monkeypatch):
    """Install a synthetic pet into a temp RUSLAN_HOME and return its slug."""
...
def _make_cli():
    ...
    # Transient-beat + reasoning state (set by RuslanCLI.__init__ in production).
    cli_obj._pet_event = ""
