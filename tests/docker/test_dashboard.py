...
def test_dashboard_slot_reports_up_when_enabled(
    ...
    start_container(
        ...
        "RUSLAN_DASHBOARD_BASIC_AUTH_PASSWORD=test-dashboard-pw",
        cmd="sleep 120",
    )
...
def test_dashboard_oauth_gate_engages_on_non_loopback_bind(
    ...
    start_container(
        built_image, container_name,
        "RUSLAN_DASHBOARD=1",
        "RUSLAN_DASHBOARD_HOST=0.0.0.0",
        "RUSLAN_DASHBOARD_OAUTH_CLIENT_ID=agent:test-instance",
        cmd="sleep 120",
    )
