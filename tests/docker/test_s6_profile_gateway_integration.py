...
The unit tests in tests/ruslan_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned ruslan-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/ruslan")
from ruslan_cli.service_manager import S6ServiceManager
