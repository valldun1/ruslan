...
class TestLoadGatewayConfigForRunner:
    ...
    def test_scoped_reload_picks_up_default_profile_token(self, tmp_path, monkeypatch):
        ...
        monkeypatch.delenv("TELEGRAM_BOT_TOKEN", raising=False)
        # Point both ruslan_constants and gateway.run at our temp home.
        monkeypatch.setattr(hc, "get_ruslan_home", lambda: home)
        monkeypatch.setattr(run_mod, "get_ruslan_home", lambda: home)
        monkeypatch.setattr(run_mod, "_ruslan_home", home)
