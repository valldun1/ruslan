...
def test_runtime_matcher_accepts_no_supervisor_restart_process():
    assert matches("python -m ruslan_cli.main gateway restart") is False
    assert matches_runtime("python -m ruslan_cli.main gateway restart") is True
    assert matches_runtime("python -m ruslan_cli.main gateway status") is False
