...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("RUSLAN_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("RUSLAN_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("RUSLAN_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
