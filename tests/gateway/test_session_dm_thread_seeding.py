...
def store(tmp_path, monkeypatch):
    ...
    ~/.ruslan/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at ruslan_state import time, before pytest's RUSLAN_HOME monkeypatch
    fires — the autouse fixture's RUSLAN_HOME override doesn't help here.)
    """
    import ruslan_state
