"""Tests for _setup_feishu() in ruslan_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("ruslan_cli.config.save_env_value", side_effect=mock_save), \
         patch("ruslan_cli.config.get_env_value", side_effect=mock_get), \
         patch("ruslan_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("ruslan_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("ruslan_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("ruslan_cli.cli_output.print_header"), \
         patch("ruslan_cli.cli_output.print_info"), \
         patch("ruslan_cli.cli_output.print_success"), \
         patch("ruslan_cli.cli_output.print_warning"), \
         patch("ruslan_cli.cli_output.print_error"), \
