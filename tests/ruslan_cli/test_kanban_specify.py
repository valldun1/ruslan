"""Tests for the specifier module + `ruslan kanban specify` CLI surface.
...
from ruslan_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `ruslan kanban …` argparse surface directly."""
