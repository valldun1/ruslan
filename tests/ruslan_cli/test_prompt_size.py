"""Tests for the ``ruslan prompt-size`` diagnostic (issue #34667)."""
...
from ruslan_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(ruslan_home, memory_text="", user_text=""):
    mem_dir = ruslan_home / "memories"
...
def _seed_skill(ruslan_home, name, description):
    skill_dir = ruslan_home / "skills" / "demo" / name
