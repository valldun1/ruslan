"""Tests for the interactive session browser (`ruslan sessions browse`).
...
from ruslan_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """ruslan sessions browse should be parseable."""
