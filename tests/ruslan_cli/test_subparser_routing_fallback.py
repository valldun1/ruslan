...
The main() function in ruslan_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `ruslan -c model`
...
def _build_parser():
    """Build a minimal replica of the ruslan top-level parser."""
