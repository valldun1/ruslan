...
def test_dry_run_prints_plan_without_mutating(monkeypatch, tmp_path, capsys):
    ...
    monkeypatch.setattr(uninstall, "_is_default_ruslan_home", lambda home: False)
    ...
    assert str(ruslan_home) in output
