...
class TestStatusEndpointTopology:
    ...
    def _setup_client(self, monkeypatch, _isolate_ruslan_home):
        try:
    ...
    def test_profile_names_and_mode_public_when_auth_gated(self, monkeypatch):
        ...
        # Ruslan Cloud Portal reads /api/status over the network (a gated bind)
        ...
        try:
            ...
            # alongside ruslan_home / gateway_pid.
            assert "gateways" not in data
            assert "ruslan_home" not in data
