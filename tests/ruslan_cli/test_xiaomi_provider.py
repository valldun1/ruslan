...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from ruslan_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in RUSLAN_OVERLAYS
        overlay = RUSLAN_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify ruslan doctor recognizes Xiaomi env vars."""
