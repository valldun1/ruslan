...
def worker_loop(worker_id: int, ruslan_home: str, result_file: str) -> None:
...
def reclaimer_loop(ruslan_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="ruslan_mixed_stress_")
    print(f"RUSLAN_HOME = {home}")
