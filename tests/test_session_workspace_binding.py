"""Session <-> workspace grouping key (ruslan_state.workspace_key).

The key is what `ruslan sessions list --workspace` groups/filters on. It is a
...
from ruslan_state import workspace_key
