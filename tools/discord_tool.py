...
Only included in the ruslan-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Ruslan-Agent (https://github.com/NousResearch/ruslan-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_ruslan_home() / "cache" / "discord_capabilities.json"
