...
def auth_json_path():
    """Return the Ruslan auth store path, respecting RUSLAN_HOME overrides."""
    return get_ruslan_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`ruslan tools`, banner/status paint, provider
