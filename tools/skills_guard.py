...
Trust levels:
  - builtin:   Ships with Ruslan. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.ruslan/\.env|\~/\.ruslan/\.env',
     "ruslan_env_access", "critical", "exfiltration",
     "directly references Ruslan secrets file"),
    ...
    (r'\.ruslan/config\.yaml|\.ruslan/SOUL\.md',
     "ruslan_config_mod", "critical", "persistence",
     "references Ruslan configuration files directly"),
...
# scan. `.skillignore` is the Ruslan-native name; `.clawhubignore` is honored
