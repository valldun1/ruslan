 ...
 *
 * Symptom: in `ruslan --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@ruslan/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using ruslan --tui and as i type multiline my caret at the end will often ' +
