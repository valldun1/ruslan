...
import type { ScrollBoxHandle } from '@ruslan/ink'
import { evictInkCaches } from '@ruslan/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.RUSLAN_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
