...
import { api, RUSLAN_BASE_PATH, buildWsAuthParam } from "@/lib/api";
...
export function ChatSidebar({
  ...
  // /api/events in ruslan_cli/web_server.py for the broadcast hop.
  //
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      ws = new WebSocket(
        `${proto}//${window.location.host}${RUSLAN_BASE_PATH}/api/events?${qs.toString()}`,
      );
