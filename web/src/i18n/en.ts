...
export const en: Translations = {
  ...
  status: {
    ...
    updateRuslanConfirmMessage:
      "This runs ruslan update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateRuslanConfirmNow: "Update now",
    updateRuslanConfirmTitle: "Update Ruslan?",
    updatingRuslan: "Updating Ruslan…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Ruslan plugins (`ruslan plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.ruslan/plugins/?",
    removeHint: "Only user-installed plugins under ~/.ruslan/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.ruslan/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Ruslan doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Ruslan Achievements",
      subtitle:
        "Collectible Ruslan badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Ruslan session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Ruslan more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Ruslan sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Ruslan is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Ruslan Agent ☤",
    },
  },
