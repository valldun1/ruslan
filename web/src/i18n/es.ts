...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateRuslan: "Actualizar Ruslan",
    updatingRuslan: "Actualizando Ruslan…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de Ruslan (equivalente a `ruslan plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.ruslan/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.ruslan/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.ruslan/skills/",
  ...
  env: {
    ...
    customHint: "Variables de entorno arbitrarias almacenadas en tu .env que Ruslan no reconoce. Úsalas para inyectar variables de entorno para skills, servidores MCP o tus propias herramientas.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Insignias coleccionables de Ruslan ganadas a partir del historial real de sesiones. Los logros conocidos no completados se muestran como Descubiertos; los logros secretos permanecen ocultos hasta que aparece el primer comportamiento coincidente.",
      scan_subtitle:
        "Escaneando el historial de sesiones de Ruslan. El primer escaneo puede tardar 5–10 segundos en historiales grandes.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Más reciente",
      latest_hint_empty: "usa Ruslan más",
    ...
    guide: {
      ...
      secret_body:
        "Los secretos ocultan su disparador exacto. Una vez que Ruslan detecta una señal relacionada, la tarjeta pasa a Descubierto y muestra su requisito.",
      scan_status_header: "Estado del escaneo",
      scan_status_body:
        "Ruslan está escaneando el historial local una vez, después las tarjetas aparecerán automáticamente. No hay nada bloqueado si tarda unos segundos.",
