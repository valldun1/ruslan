...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateRuslan: string;
    updateRuslanConfirmMessage?: string;
    updateRuslanConfirmNow?: string;
    updateRuslanConfirmTitle?: string;
    updatingRuslan: string;
  ...
  // ── Achievements plugin (plugins/ruslan-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
