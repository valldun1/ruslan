 ...
 *
 * Values mirror ruslan_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Ruslan default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Ruslan' default when unset). */
