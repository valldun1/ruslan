 ...
 *
 * Plugins call window.__RUSLAN_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__RUSLAN_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__RUSLAN_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__RUSLAN_PLUGIN_SDK__ = {
    ...
    // window.__RUSLAN_SESSION_TOKEN__ directly.
    authedFetch,
