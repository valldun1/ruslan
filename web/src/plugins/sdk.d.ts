/**
 * Ruslan Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__RUSLAN_PLUGIN_SDK__`` and
 * ``window.__RUSLAN_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__RUSLAN_PLUGIN_SDK__`` because:
 ...
 *   - Ship as a published ``@ruslan/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__RUSLAN_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__RUSLAN_PLUGINS__)
// ---------------------------------------------------------------------------
