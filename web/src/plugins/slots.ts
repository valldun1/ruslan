 ...
 * `window.__RUSLAN_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Ruslan brand in the top bar
 ...
 *  `window.__RUSLAN_PLUGINS__.registerSlot(...)`.
 *
