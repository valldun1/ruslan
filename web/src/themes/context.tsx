...
const STORAGE_KEY = "ruslan-dashboard-theme";
...
const FONT_STORAGE_KEY = "ruslan-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `ruslan_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "ruslan-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-ruslan-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-ruslan-theme-font", "true");
