 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `ruslan_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Ruslan Teal",
  description: "Classic dark teal — the canonical Ruslan look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Ruslan look, ported from the
 ...
 * nousnet-web's <body> is white; ruslan-agent's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Ruslan Teal (Large)",
  description: "Ruslan Teal with bigger fonts and roomier spacing",
