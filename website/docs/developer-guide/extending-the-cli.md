...
description: "Build wrapper CLIs that extend the Ruslan TUI with custom widgets, keybindings, and layout changes"
---
...
Called after Ruslan registers its own keybindings and before the layout is built. Add your keybindings to `kb`.
