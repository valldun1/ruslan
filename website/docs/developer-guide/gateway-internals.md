...
- **Explicit target delivery** — `send_message` tool specifying `telegram:-1001234567890`, or the [`ruslan send` CLI](/guides/pipe-script-output) wrapping the same tool for shell scripts
