...
See [Building a Ruslan Plugin](/developer-guide/plugins#distribute-via-pip) for the full entry-points setup.
...
- [Building a Ruslan Plugin](/developer-guide/plugins) — general plugin authoring
