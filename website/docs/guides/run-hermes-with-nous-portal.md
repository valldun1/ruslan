...
ruslan auth add nous --type oauth
...
If a model is genuinely unavailable, [open an issue](https://github.com/NousResearch/ruslan-agent/issues) — most gaps are routing config we can update.
