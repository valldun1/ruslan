...
[Download the Ruslan Desktop installer](https://ruslan.team/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).
...
Prefer to review first? Download [`install.sh`](https://ruslan.team/install.sh), inspect it, then run it.
