...
For how to ship skills in your own plugin, see [Build a Ruslan Plugin → Bundle skills](/developer-guide/plugins#bundle-skills).
...
ruslan config get skills.config --json
```
