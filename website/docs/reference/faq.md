...
cd ~/.ruslan/ruslan-agent && uv pip install -e ".[messaging]"  # Telegram, Discord, Slack, and shared gateway deps
...
1. **Search existing issues:** [GitHub Issues](https://github.com/NousResearch/ruslan-agent/issues)
