...
See the [Plugins](/user-guide/features/plugins) page for the general plugin system, and [Build a Ruslan Plugin](/developer-guide/plugins) to write your own.
...
Bundled plugins are written exactly like any other Ruslan plugin — see [Build a Ruslan Plugin](/developer-guide/plugins). The only differences are:
