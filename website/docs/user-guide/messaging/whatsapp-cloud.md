...
Message-template support (the workaround for outside-window sends) is not yet implemented in Ruslan. If you need it, please [open an issue](https://github.com/valldun1/ruslan/issues) — it's planned but waiting on a clear demand signal.
