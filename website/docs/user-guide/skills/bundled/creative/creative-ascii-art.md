...
```bash
python3 -m pyfiglet "RUSLAN" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=RUSLAN&font=Slant" | boxes -d stone
```
