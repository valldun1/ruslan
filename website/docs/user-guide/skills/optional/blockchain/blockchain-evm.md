...
| | |
|---|---|
| Source | Optional — install with `ruslan skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Ruslan Agent |
| License | MIT |
...
Helper script path: `~/.ruslan/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.ruslan/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.ruslan/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.ruslan/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
