...
| | |
|---|---|
| Source | Optional — install with `ruslan skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Ruslan Agent |
| License | MIT |
...
The script reads `${RUSLAN_HOME:-~/.ruslan}/.env` for two optional defaults:
...
Helper script: `~/.ruslan/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.ruslan/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${RUSLAN_HOME:-~/.ruslan}/.env`.
...
```bash
python3 ~/.ruslan/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.ruslan/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
