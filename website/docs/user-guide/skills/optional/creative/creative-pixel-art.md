...
| | |
|---|---|
| Source | Optional — install with `ruslan skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.ruslan/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.ruslan/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Ruslan installs package this)
