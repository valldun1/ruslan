...
| | |
|---|---|
| Source | Optional — install with `ruslan skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Ruslan Agent |
| License | MIT |
...
```
SCRIPT=~/.ruslan/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.ruslan/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
