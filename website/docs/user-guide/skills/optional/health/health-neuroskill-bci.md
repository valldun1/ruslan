...
| | |
|---|---|
| Source | Optional — install with `ruslan skills install official/health/neuroskill-bci` |
...
Connect Ruslan to a running [NeuroSkill](https://neuroskill.com/) instance to read
