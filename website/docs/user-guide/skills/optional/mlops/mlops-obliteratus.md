...
| | |
|---|---|
| Source | Optional — install with `ruslan skills install official/mlops/obliteratus` |
...
**License warning:** OBLITERATUS is AGPL-3.0. NEVER import it as a Python library. Always invoke via CLI (`obliteratus` command) or subprocess. This keeps Ruslan Agent's MIT license clean.

## Video Guide

Walkthrough of OBLITERATUS used by a Ruslan agent to abliterate Gemma:
