...
| | |
|---|---|
| Source | Optional — install with `ruslan skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Ruslan Agent |
| License | MIT |
...
import upstream classes into Ruslan itself.
...
```bash
mkdir -p ~/.ruslan/cache/darwinian-evolver && cd ~/.ruslan/cache/darwinian-evolver
...
```bash
cd ~/.ruslan/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.ruslan/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.ruslan/skills/research/darwinian-evolver
DE_DIR=~/.ruslan/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Ruslan core.
   Custom driver scripts under `~/.ruslan/skills/...` are user-side and fine.
