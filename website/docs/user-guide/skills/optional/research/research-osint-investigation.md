...
| | |
|---|---|
| Source | Optional — install with `ruslan skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Ruslan Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $RUSLAN_OSINT_CACHE/icij/ (default: ~/.cache/ruslan-osint/icij/).
...
# Set RUSLAN_OSINT_UA=your-app/1.0 (your@email) to identify yourself
