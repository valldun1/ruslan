...
| | |
|---|---|
| Source | Optional — install with `ruslan skills install official/research/qmd` |
...
Ruslan Agent via the native MCP client. This is the preferred
...
Then configure Ruslan Agent to connect via HTTP:
