...
- User wants **Ruslan itself to drive a browser** → use Ruslan' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
