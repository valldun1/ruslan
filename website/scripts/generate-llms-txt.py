#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Ruslan docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Ruslan as a Python Library", None),
        ("guides/use-mcp-with-ruslan", "Use MCP with Ruslan", None),
        ("guides/use-voice-mode-with-ruslan", "Use Voice Mode with Ruslan", None),
        ("guides/use-soul-with-ruslan", "Use SOUL.md with Ruslan", None),
        ("guides/build-a-ruslan-plugin", "Build a Ruslan Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Ruslan"),
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Ruslan Agent — Full Documentation\n",
        (
            "This file is the entire Ruslan Agent documentation concatenated for LLM "
